# -*- coding: utf-8 -*-
#
# pytest-filter_exceptions documentation build configuration file, created by
...
project = 'pytest-filter_exceptions'
copyright = '2015, Akhilesh R'
author = 'Akhilesh R'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-filter_exceptions Documentation',
     [author], 1)
]
